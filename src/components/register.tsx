...
const Register: React.FC = () => {
  ...
  return (
    <Box
      sx={{
        minHeight: "100vh",
        backgroundColor: "white", // 🔧 רקע לבן למקום הכחול
        display: "flex",
        fontFamily: "Arial, sans-serif",
        position: "relative"
      }}
    >
      {/* לוגו הכי בפינה של כל העמוד - כמו בAuth */}
      <Box
        sx={{
          position: "fixed", // 🔧 שינוי מ-absolute ל-fixed
          top: 0, // 🔧 שינוי מ-10 ל-0
          right: 0, // 🔧 שינוי מ-10 ל-0
          display: "flex",
          alignItems: "center",
          gap: 1,
          zIndex: 1000,
          padding: "10px" // 🔧 רווח פנימי במקום margin חיצוני
        }}
      >
        <Typography 
          variant="h6"
    ...
    ResumeBuilder
      ...
      <Box
        sx={{
          ...
          alignItems: "center",
          justifyContent: "flex-start", // 🔧 הרבה יותר שמאלה
          backgroundColor: "white",
          paddingLeft: "40px" // 🔧 רווח מהקצה השמאלי
        }}
      >
        <Box
          sx={{
        ...
        >
          ...
          <Box
            sx={{
              ...
              transform: "rotate(-2deg)", // 🔧 סיבוב קל לעניין
          ...
          <Box
            sx={{
              ...
              borderRadius: "20px",
              transform: "rotate(-2deg)", // 🔧 אותו סיבוב כמו המסך
